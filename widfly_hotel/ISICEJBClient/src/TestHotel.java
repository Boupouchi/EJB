...
final Context context = new InitialContext(jndiProperties);
		...
		return (IDaoRemote<Ville>) context.lookup("ejb:ISICEJBEAR/ISICEJBServer/anasVille!dao.IDaoRemote");
...
final Context context = new InitialContext(jndiProperties);
		...
		return (IDaoRemote<Hotel>) context.lookup("ejb:ISICEJBEAR/ISICEJBServer/anasHotel!dao.IDaoRemote");
